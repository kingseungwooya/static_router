...
public class EthernetLayer implements BaseLayer {
   ...
   public byte[] ObjToByte(_ETHERNET_HEADER Header, byte[] input, int length) {//dataï¿½ë  ï¿½ë¿¤ï¿½ë    ºì  ë¿¬ä  ¨ë¦°
   ...
   public boolean Send(byte[] input, int length) {
      ...
      System.out.println("³­ EthernetÀÇ Send. ÆÐÅ¶À» º¸³»Áö.");
      return true;
   }
   ...
   public boolean Receive(byte[] input) {
      ...
      //System.out.println("ÀÌ´õ³Ý input !!!"+input.length);
   ...
   // Òï©ì  ×Ù ê°     ¸ì (ethernet header   dstì£¼ì  ê°     ¸ì      ) 
